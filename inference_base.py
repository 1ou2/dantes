"""
Inference script for the BASE Mistral 7B model (before fine-tuning)
...
def load_model(max_seq_length=2048):
...
def interactive_mode(model, tokenizer):
    ...
    print("=" * 60)
    print("🤖 Conversation avec le modèle BASE Mistral 7B")
    print("=" * 60)
...
def test_examples(model, tokenizer):
    """Test with example questions (same as fine-tuned model for comparison)"""
    examples = [
    ...
    print("=" * 60)
    print("🧪 Testing BASE model with example questions")
    print("=" * 60)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inference with BASE Mistral 7B model")
